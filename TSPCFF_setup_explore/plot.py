...
# We drop any incomplete trailing value to keep complete (clk, prop) pairs.
...
for row in raw:
    ...
    plt.plot(clk_ps, prop_ns, marker='o', linewidth=1.5, label=label)
...
# Show legend only if multiple curves exist
